...
export interface ItemsYobta {
  ...
  <R1, R2, R3>(...rules: SyncRulesChain3<R1, R2, R3>): SyncRule<unknown[], R3[]>
  <R1, R2>(...rules: SyncRulesChain2<R1, R2>): SyncRule<unknown[], R2[]>
  <R1>(...rules: SyncRulesChain1<R1>): SyncRule<unknown[], R1[]>
  <F extends SyncRules>(
    ...rules: SyncRulesPipeYobta<F>
  ): SyncRule<unknown[], PipeFactoryResult<F>[]>
}
